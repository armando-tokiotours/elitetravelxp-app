...
export function ConciergeSuggestionCard({
  ...
  return (
    <div className="mt-2 overflow-hidden rounded-xl border border-[#C4A35A]/55 bg-gradient-to-br from-[#FBF6EA] to-[#F7F1E4] p-3 shadow-[0_4px_16px_rgba(196,163,90,0.12)]">
