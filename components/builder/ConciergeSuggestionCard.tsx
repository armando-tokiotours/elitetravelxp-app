...
export function ConciergeSuggestionCard({
  ...
  return (
    <div className="mt-2 overflow-hidden rounded-xl border border-[#B85304]/55 bg-gradient-to-br from-[#FDF7F3] to-[#F7F1E4] p-3 shadow-[0_4px_16px_rgba(184, 83, 4,0.12)]">
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[0.65rem] font-semibold uppercase tracking-[0.18em] text-[#B85304]">
            ✨ {badge}
          </p>
          ...
          {tourId && onAddTour ? (
            <button
              ...
              className="mt-2 rounded-full border border-zinc-600 bg-zinc-900 px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-[#0B1F3A] hover:text-white disabled:cursor-default disabled:border-[#B85304]/50 disabled:bg-zinc-950 disabled:text-[#F3D9C4]"
            >
              {tourAlreadyAdded
