...
export function BuilderHero({ branding }: { branding: PbSiteBranding | null }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="builder-hero-bg absolute inset-0 bg-[#0a0a0a] bg-cover bg-[position:60%_center] bg-no-repeat md:bg-center"
        ...
        <div className="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent sm:h-32" />
      </div>
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-start px-5 pb-14 pt-16 sm:px-8 sm:pb-16 sm:pt-20 md:px-12">
        <div className="flex max-w-[min(100%,28rem)] flex-col items-start text-left md:max-w-2xl">
          <h1 className="builder-hero-title flex flex-col items-start uppercase leading-none">
            <span className="text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]">
              BUILD
            </span>
            <span className="text-[0.8em] text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]">
              YOUR PERFECT
            </span>
            <span className="text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]">
              JAPAN TRIP
