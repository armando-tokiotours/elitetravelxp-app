    ...
    <AnimatePresence>
      {open && tour ? (
        ...
        >
          ...
          >
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#075473]">
              Schedule experience
            </p>
                    ...
                    <button
                      ...
                      className={`flex w-full flex-col items-start gap-0.5 rounded-2xl border px-4 py-3 text-left transition sm:flex-row sm:items-center sm:justify-between ${
                        disabled
                          ...
                          : "border-[#EEE8DF] bg-[#FBF8F2] hover:border-[#075473]/70 hover:bg-white"
                      }`}
                    >
                      ...
                      {disabled ? (
                        ...
                        <span className="text-xs text-[#075473]">
