        ...
        >
          ...
          >
            ...
            <div className="space-y-4 px-5 pb-2">
              ...
              <div>
                <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-[#B85304]">
                  Payment type
                </p>
              ...
              <div className="grid gap-3">
                <label className="block">
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full rounded-xl border border-[#E8E2D9] bg-white px-3 py-2.5 text-sm text-[#0B1F3A] outline-none focus:border-[#B85304]"
    ...
    <button
      ...
      className={`rounded-xl border px-3 py-2.5 text-left transition ${
        active
          ...
          : "border-[#E8E2D9] bg-white text-[#0B1F3A] hover:border-[#B85304]"
      }`}
    >
