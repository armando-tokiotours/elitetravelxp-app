    ...
    <div className="mb-5">
      <div className="mb-3 flex flex-wrap items-center gap-2">
        <button
          ...
          className="rounded-full border border-[#D9D2C7] bg-white px-4 py-2 text-sm font-semibold text-[#0B1F3A] transition hover:border-[#C4A35A] disabled:opacity-50"
        >
      ...
      <label
        ...
        className={`flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed px-4 py-8 text-center transition ${
          dragOver
            ...
            : "border-[#D9D2C7] bg-[#FBF8F2] hover:border-[#C4A35A]"
        } ${busy ? "opacity-60" : ""}`}
      >
